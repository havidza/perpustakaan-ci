...
class Booking extends CI_Controller
{
    ...
    public function viewDataBooking()
    {
        $email_user = $this->session->userdata('email');
        $data['detail_booking'] = $this->ModelBooking->getDataWhere('temp', ['email_user' => $email_user])->result();
    ...
    public function exportToExcel()
    {
        ...
        header("Content-Disposition: attachment; filename=Bukti_Booking_$id_user.xls");

        $this->load->view('booking/export', $data);
    }
...
public function exportToPdf()
    {
        ...
        include $sroot."/pw/pustaka-booking/application/third_party/dompdf/autoload.inc.php";
